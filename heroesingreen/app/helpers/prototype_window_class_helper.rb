...
module PrototypeWindowClassHelper
    ...
    def link_to_prototype_ajax_dialog( name, content_hash, dialog_kind = 'alert', options = { :windowParameters => {} } , html_options = {} )
        ...
        js_code ="Dialog.#{dialog_kind}( #{params_for_javascript(content_hash)},  #{params_for_javascript(options) } ); "
        content_tag(
               "a", name, 
               html_options.merge({ 
